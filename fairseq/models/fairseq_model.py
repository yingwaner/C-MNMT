...
class FairseqEncoderDecoderModel(BaseFairseqModel):
    ...
    def forward(self, lang_pair, src_tokens, src_lengths, prev_output_tokens, **kwargs):
        """
        ...
        """
        encoder_out = self.encoder(lang_pair, src_tokens, src_lengths=src_lengths, **kwargs)
