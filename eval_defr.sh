...
ALPHA=0.6
BATCH=250
DATABIN=/data/wanying/1.research/multilingual/data-bin/iwslt17/FrRo-En
...
#    echo -e "\t$v\t$bleu"
    ...
    for i in $(seq 0 $max); do
        ...
        --buffer-size 2000 --lang-pairs ro-en,fr-en \
        --beam $BEAM --batch-size $BATCH --remove-bpe \
        --lenpen $ALPHA --log-format=none > $OUT_DIR/${m_name}.$t
